  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-text">Agents Directory</h1>
      </div>

      <div className="bg-card border border-border rounded-lg shadow-sm">
        <div className="p-4 border-b border-border flex justify-between items-center bg-page/50">
          <input type="text" placeholder="Search by name, email, or agency..." className="border border-border rounded-md px-3 py-1.5 text-sm w-80" />
        </div>
        <div className="p-0">
            ...
            <tbody>
              <tr className="border-b border-border hover:bg-page transition-colors h-row">
                <td className="px-4 py-3">
                  ...
                  <div className="text-muted text-meta">john@example.com</div>
                </td>
                <td className="px-4 py-3 text-text">LJ Hooker</td>
                <td className="px-4 py-3 text-muted">Principal</td>
