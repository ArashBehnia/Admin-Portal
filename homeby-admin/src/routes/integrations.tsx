        ...
        <div className="space-y-6">
            ...
            <div className="bg-card border border-border rounded-lg shadow-sm">
                <div className="flex border-b border-border">
                    <button className="px-6 py-3 text-accent border-b-2 border-accent font-medium">
                        Inbound Feeds
                    </button>
                    <button className="px-6 py-3 text-muted hover:text-text font-medium">
                        Distribution
                    </button>
                </div>
                <div className="p-6">
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr className="border-b border-border hover:bg-page transition-colors h-row border-l-2 border-l-danger">
                                <td className="py-3 text-text pl-3">
                                    Ray White
                                </td>
                                <td className="py-3">
