            ...
            {selectedApp && (
                <>
                    ...
                    <div className="fixed top-0 right-0 h-full w-[450px] bg-white shadow-2xl z-[60] flex flex-col border-l border-gray-200 overflow-hidden animate-in slide-in-from-right duration-200">
                            ...
                            <div className="flex gap-6">
                                {["Application", "Verification", "Notes"].map((tab) => (
                                    <button
                                        ...
                                        className={cn(
                                            "py-3 text-[14px] font-medium border-b-2 transition-colors",
                        ...
                        {/* Scrollable Content */}
                        <div className="flex-1 overflow-y-auto p-6 bg-white [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                            {activeTab === "Application" && (
                                <div className="flex flex-col gap-8">
                                    <div className="flex flex-col gap-4">
                                        <h3 className="text-[12px] font-bold text-gray-500 uppercase tracking-wider">Agency Details</h3>
                                        <div className="flex flex-col gap-3 text-[14px]">
                                            ...
                                            <div className="grid grid-cols-[130px_1fr] gap-x-2 items-center">
                                                ...
                                                <div>
                                                    <span className="inline-block px-2 py-0.5 rounded text-[12px] font-medium bg-gray-100 text-gray-600 border border-gray-200">
                                                        {selectedApp.crm}
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        <h3 className="text-[12px] font-bold text-gray-500 uppercase tracking-wider">Agent Details</h3>
                                        <div className="flex flex-col gap-3 text-[14px]">
                                            <div className="grid grid-cols-[130px_1fr] gap-x-2">
                            ...
                            {activeTab === "Verification" && (
                                <div className="flex flex-col gap-4">
                                    <h3 className="text-[14px] font-bold text-gray-900 mb-2">Verification checks</h3>
                                    
                                    <div className="bg-white border border-gray-200 rounded shadow-sm p-4 flex flex-col gap-2">
                                        <div className="flex items-center justify-between">
                                            <h4 className="text-[14px] font-bold text-gray-900">ABN Lookup</h4>
                                            <span className="text-green-600 text-[12px] font-bold bg-green-50 px-2 py-0.5 rounded">Verified</span>
                                        </div>
                                        <div className="text-[14px] text-gray-900 mt-1">45 123 456 789</div>
                                        <div className="text-[13px] text-gray-500">Entity: {selectedApp.agency} Pty Ltd · GST registered: Yes</div>
                                        <button className="px-3 py-1.5 bg-white border border-gray-200 rounded text-[13px] font-medium hover:bg-gray-50 self-start mt-2">
                                            Re-check ABN
                                        </button>
                                    </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded shadow-sm p-4 flex flex-col gap-2">
                                        <div className="flex items-center justify-between">
                                            <h4 className="text-[14px] font-bold text-gray-900">Agent Licence</h4>
                                            <span className="text-orange-600 text-[12px] font-bold bg-orange-50 px-2 py-0.5 rounded">Manual check required</span>
                                        </div>
                                        <div className="text-[14px] text-gray-900 mt-1">LIC-NSW-28441</div>
                                        <div className="text-[13px] text-gray-500 leading-relaxed">
                                            Auto-verification unavailable for NSW. Please verify manually at NSW Fair Trading.
                                        </div>
                                        <button className="text-[#2B5CE6] text-[13px] font-medium hover:underline self-start">
                                            NSW Fair Trading →
                                        </button>
                                        <button className="px-3 py-1.5 bg-white border border-gray-200 rounded text-[13px] font-medium hover:bg-gray-50 self-start mt-2">
                                            Mark as verified
                            ...
                            {activeTab === "Notes" && (
                                <div className="flex flex-col gap-4 h-full">
                                    <textarea 
                                        ...
                                        className="w-full h-[200px] bg-white border border-gray-200 rounded p-3 text-[14px] focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
                                    />
                                    <button className="px-4 py-2 bg-[#2B5CE6] text-white hover:bg-blue-700 rounded text-[14px] font-medium self-end transition-colors">
                                        Save
                                    </button>
                                </div>
                            )}
