...
const IntegrationsPageClient = ({
  ...
  return (
    <div className="w-full max-w-content mx-auto flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-muted text-[12px] sm:text-[13px] mt-0.5 leading-relaxed">
            Monitor agency CRM connections, inbound feed health, and outbound
            listing distribution. Read-only — feed setup is managed by agencies
            through the portal.
          </p>
        </div>
      ...
      <IntegrationDetailsPanel feed={selectedFeed} onClose={closeDetails} />
    </div>
  );
};
