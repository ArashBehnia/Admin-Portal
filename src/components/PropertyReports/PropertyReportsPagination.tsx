...
import { ROWS_PER_PAGE } from "@/types/propertyReportTypes";

interface PropertyReportsPaginationProps {
    currentPage: number;
    totalPages: number;
    totalCount: number;
...
const PropertyReportsPagination = ({
    currentPage,
    totalPages,
    totalCount,
    onPageChange,
}: PropertyReportsPaginationProps) => {
...
export default PropertyReportsPagination;
